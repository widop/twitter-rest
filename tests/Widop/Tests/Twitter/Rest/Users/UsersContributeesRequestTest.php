 ...
 */
class UsersContributeesRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Widop\Twitter\Rest\Users\UsersContributeesRequest */
    private $request;
    ...
    {
        $this->request = new UsersContributeesRequest();
    }
