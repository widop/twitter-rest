 ...
 */
class ListsSubscribersDestroyRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Widop\Twitter\Rest\Lists\ListsSubscribersDestroyRequest */
    private $request;
    ...
    {
        $this->request = new ListsSubscribersDestroyRequest();
    }
