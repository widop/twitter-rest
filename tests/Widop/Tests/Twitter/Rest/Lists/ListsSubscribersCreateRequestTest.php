 ...
 */
class ListsSubscribersCreateRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Widop\Twitter\Rest\Lists\ListsSubscribersCreateRequest */
    private $request;
    ...
    {
        $this->request = new ListsSubscribersCreateRequest();
    }
