 ...
 */
class ListsMembersDestroyRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var \Widop\Twitter\Rest\Lists\ListsMembersDestroyRequest */
    private $request;
    ...
    {
        $this->request = new ListsMembersDestroyRequest();
    }
